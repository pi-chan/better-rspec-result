...
require_relative "lib/better_rspec_result/version"

Gem::Specification.new do |spec|
  spec.name = "better-rspec-result"
  spec.version = BetterRspecResult::VERSION
  ...
  spec.files = Dir.chdir(__dir__) do
    Dir["{lib,exe}/**/*", "*.md", "LICENSE*", "CHANGELOG*", "*.gemspec"].reject do |f|
      File.directory?(f)
    end
  end
  spec.bindir = "exe"
